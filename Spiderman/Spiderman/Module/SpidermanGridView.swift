...
open class SpidermanGridCell<U>: SpidermanCollectionCell {
    open func configCell(_ data: U) {
        
    }
}

open class SpidermanGridView<C: SpidermanGridCell<U>, U>: SpidermanView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
