...
open class SpidermanHeaderListView<H: SpidermanListHeader<B>, B, C: SpidermanListCell<T>, T>: SpidermanCtr, UITableViewDataSource, UITableViewDelegate {
...
open class SpidermanHeader: UITableViewHeaderFooterView {
...
open class SpidermanListHeader<B>: SpidermanHeader {
    open func configHeader(_ data: B) {}
}

open class SpidermanDefaultHeader: SpidermanListHeader<String> {
    ...
    open override func setupView() {
        super.setupView()
        let view = UIView()
        view.backgroundColor = UIColor.Spiderman.superLightGray
        addSubviews(view)
