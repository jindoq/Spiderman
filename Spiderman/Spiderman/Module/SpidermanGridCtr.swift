...
open class SpidermanGridCtr<C: SpidermanGridCell<U>, U>: SpidermanCtr, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
