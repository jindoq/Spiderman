...
public struct UIMaker {
    public static func makeActionBtn(text: String? = nil, color: UIColor = .white, fontSize: CGFloat = 16, isBold: Bool = false, bgColor: UIColor = UIColor.Spiderman.green) -> SpidermanButton {
        let btn = SpidermanButton()
